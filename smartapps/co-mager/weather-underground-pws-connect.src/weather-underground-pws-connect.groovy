...
preferences {
    ...
    section("Configure your Weather Underground credentials") {
        input "weatherID", "text", title: "Weather Station ID", required: false
        input "password", "password", title: "Weather Underground password", required: false
...
def updateCurrentWeather() {
    ...
    try {
        ...
        httpGet("http://api.wunderground.com/api/3a317458941ad822/conditions/q/NY/New_York.json") { resp ->   
